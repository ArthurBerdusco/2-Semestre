...
function montaLista() {
    ...
    for (i = 0; i < listaFilmes.length; i++) {
        list.innerHTML += `<li><a href="https://senacsp.blackboard.com/webapps/blackboard/content/listContent.jsp?course_id=_205238_1&content_id=_9523619_1">${list.children.length + 1} - ${listaFilmes[i]}</a></li>`;
    }
